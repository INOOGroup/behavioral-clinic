package com.example.application.views.clinic;
...
@PageTitle("Clinic")
@Route(value = "clinic/:clinicID?/:action?(edit)", layout = MainLayout.class)
@Tag("clinic-view")
@JsModule("./views/clinic/clinic-view.ts")
public class ClinicView extends Composite<VerticalLayout> {
