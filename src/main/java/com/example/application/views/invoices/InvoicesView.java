...
@PageTitle("Invoices")
@Route(value = "invoices/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@Tag("invoices-view")
@JsModule("./views/invoices/invoices-view.ts")
@Uses(Icon.class)
public class InvoicesView extends LitTemplate implements HasStyle, BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "invoices/%s/edit";
    ...
    public InvoicesView(SamplePersonService samplePersonService) {
        this.samplePersonService = samplePersonService;
        addClassNames("invoices-view");
