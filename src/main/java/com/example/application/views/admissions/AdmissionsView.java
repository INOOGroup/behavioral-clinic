package com.example.application.views.admissions;
...
@Route(value = "admission/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@Tag("admissions-view")
@JsModule("./views/admissions/admissions-view.ts")
@Uses(Icon.class)
public class AdmissionsView extends LitTemplate implements HasStyle, BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "admission/%s/edit";
    ...
    public AdmissionsView(SamplePersonService samplePersonService) {
        this.samplePersonService = samplePersonService;
        addClassNames("admissions-view");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(AdmissionsView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(AdmissionsView.class);
            }
        }
    }
