...
@customElement('clinic-view')
export class ClinicView extends LitElement {
  createRenderRoot() {
      ...
      <div class="editor-layout">
        <div class="editor">
          <vaadin-form-layout>
            ...
            ><vaadin-date-time-picker label="Created on" id="created_on" step="1"></vaadin-date-time-picker
            ><vaadin-text-field label="Created by" id="created_by"></vaadin-text-field>
          </vaadin-form-layout>
        </div>
